...
class RegionMinusSuite extends FunSuite {
  ...
  def minusEmpty(): Unit = {
    test("Empty minus") {
      ...
      assert(Empty.minus(chr1_1000_2000_unstranded) === Empty, "Empty minus block should be empty")
    }
  }

  def minusBlockEmpty(): Unit = {
    test("Block minus Empty") {
      assert(chr1_1000_2000_unstranded.minus(Empty) === chr1_1000_2000_unstranded,
  ...
  def minusBlockBlock(): Unit = {
    test("Block minus Block") {
      ...
      assert(chr1_4_6_minus.minus(chr1_5_6_minus) === Block("chr1", 4, 5, Minus),
        "Block minus nested block sharing one endpoint should be the rest of the interval")
      // Overlapping blocks
      assert(chr1_1000_2000_both.minus(chr1_1500_2500_plus) === Block("chr1", 1000, 1500, Both),
  ...
  def minusBlockBlockSet(): Unit = {
    test("Block minus BlockSet") {
      ...
      assert(chr1_1000_2000_both.minus(chr1_1000_1100_1900_2000_plus) === Block("chr1", 1100, 1900, Both),
      ...
      assert(Block("chr1", 1000, 1050, Plus).minus(chr1_1000_1100_1200_1300_1900_2000_plus) === Empty,
        "Block nested inside block set sharing one endpoint")
      assert(Block("chr1", 1050, 1100, Plus).minus(chr1_1000_1100_1200_1300_1900_2000_plus) === Empty,
        "Block nested inside block set sharing one endpoint")
      assert(Block("chr1", 1200, 1250, Plus).minus(chr1_1000_1100_1200_1300_1900_2000_plus) === Empty,
        "Block nested inside block set sharing one endpoint")
      assert(Block("chr1", 1250, 1300, Plus).minus(chr1_1000_1100_1200_1300_1900_2000_plus) === Empty,
        "Block nested inside block set sharing one endpoint")
      assert(Block("chr1", 1900, 1950, Plus).minus(chr1_1000_1100_1200_1300_1900_2000_plus) === Empty,
        "Block nested inside block set sharing one endpoint")
      assert(Block("chr1", 1950, 2000, Plus).minus(chr1_1000_1100_1200_1300_1900_2000_plus) === Empty,
        "Block nested inside block set sharing one endpoint")
      // Overlapping one block off end
      assert(chr1_1000_2000_both.minus(chr1_1900_2100_3000_4000_plus) === Block("chr1", 1000, 1900, Both),
        "Overlapping one block off end")
      assert(chr1_1500_2500_plus.minus(chr1_1900_2100_3000_4000_plus) === BlockSet(List(
        ...
        "Overlapping one block off end")
      assert(Block("chr1", 1400, 1550, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1400, 1500, Plus), "Overlapping one block off end")
      assert(Block("chr1", 1550, 1650, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1600, 1650, Plus), "Overlapping one block off end")
      assert(Block("chr1", 1650, 1750, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1650, 1700, Plus), "Overlapping one block off end")
      assert(Block("chr1", 1750, 1850, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1800, 1850, Plus), "Overlapping one block off end")
      assert(Block("chr1", 2000, 2150, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 2000, 2100, Plus), "Overlapping one block off end")
      assert(Block("chr1", 2200, 2350, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 2300, 2350, Plus), "Overlapping one block off end")
      ...
      assert(Block("chr1", 1750, 2200, Plus).minus(chr1_1700_1800_1900_2100_plus) === BlockSet(List(
        Block("chr1", 1800, 1900, Plus),
        Block("chr1", 2100, 2200, Plus)
      )), "Overlapping two blocks off end")
      assert(Block("chr1", 1400, 1750, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("chr1", 1400, 1500, Plus),
        Block("chr1", 1600, 1700, Plus)
      )), "Overlapping two blocks off end")
      assert(Block("chr1", 1550, 1850, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("chr1", 1600, 1700, Plus),
        Block("chr1", 1800, 1850, Plus)
      )), "Overlapping two blocks off end")
      assert(Block("chr1", 1650, 2200, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("chr1", 1650, 1700, Plus),
        Block("chr1", 1800, 2100, Plus)
      )), "Overlapping two blocks off end")
      assert(Block("chr1", 1750, 2400, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("chr1", 1800, 2100, Plus),
      ...
      assert(Block("chr1", 1650, 2400, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("chr1", 1650, 1700, Plus),
        Block("chr1", 1800, 2100, Plus),
        Block("chr1", 2300, 2400, Plus)
      )), "Overlapping two blocks and an intron")
      // Overlapping three blocks and intron
      assert(Block("chr1", 500, 6500, Plus).minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus) === BlockSet(List(
      ...
      assert(Block("chr1", 2500, 8500, Plus).minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus) === BlockSet(List(
      ...
      assert(Block("chr1", 1500, 1600, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "Same span as one block")
      assert(Block("chr1", 1700, 1800, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "Same span as one block")
      assert(Block("chr1", 2100, 2300, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "Same span as one block")
      ...
      assert(Block("chr1", 1500, 7500, Plus).minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus) === BlockSet(List(
        Block("chr1", 2000, 3000, Plus),
        Block("chr1", 4000, 5000, Plus),
        Block("chr1", 6000, 7000, Plus)
      )), "Contains two blocks and overlaps two adjacent blocks")
      // Contains one block sharing an endpoint
      assert(Block("chr1", 1400, 1600, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1400, 1500, Plus), "Contains one block sharing an endpoint")
      assert(Block("chr1", 1500, 1650, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1600, 1650, Plus), "Contains one block sharing an endpoint")
      assert(Block("chr1", 1650, 1800, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1650, 1700, Plus), "Contains one block sharing an endpoint")
      assert(Block("chr1", 1700, 1850, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1800, 1850, Plus), "Contains one block sharing an endpoint")
      assert(Block("chr1", 2000, 2300, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 2000, 2100, Plus), "Contains one block sharing an endpoint")
      assert(Block("chr1", 2100, 2400, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 2300, 2400, Plus), "Contains one block sharing an endpoint")
      ...
      assert(Block("chr1", 500, 600, Both).minus(chr1_100_200_300_400_plus) ===
        Block("chr1", 500, 600, Both), "Non-overlapping because different spans")
      assert(Block("chr1", 1000, 1100, Both).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1000, 1100, Both), "Non-overlapping because different spans")
      assert(Block("chr1", 2400, 2500, Both).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 2400, 2500, Both), "Non-overlapping because different spans")
      ...
      // Two blocks
      assert(Block("chr1", 200, 300, Plus).minus(chr1_100_200_300_400_plus) ===
        Block("chr1", 200, 300, Plus), "Same span as an intron")
      // Three blocks
      assert(Block("chr1", 1600, 1700, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1600, 1700, Plus), "Same span as an intron")
      assert(Block("chr1", 1800, 2100, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1800, 2100, Plus), "Same span as an intron")
      // Adjacent to span
      // Two blocks
      assert(Block("chr1", 50, 100, Plus).minus(chr1_100_200_300_400_plus) ===
        Block("chr1", 50, 100, Plus), "Adjacent to span")
      assert(Block("chr1", 400, 500, Plus).minus(chr1_100_200_300_400_plus) ===
        Block("chr1", 400, 500, Plus), "Adjacent to span")
      // Three blocks
      assert(Block("chr1", 1400, 1500, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1400, 1500, Plus), "Same span as an intron")
      assert(Block("chr1", 2300, 2400, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 2300, 2400, Plus), "Same span as an intron")
      // 1bp gap between blocks
      // In intron
      assert(Block("chr1", 201, 300, Plus).minus(chr1_100_200_300_400_plus) ===
        Block("chr1", 201, 300, Plus), "1bp gap between blocks")
      assert(Block("chr1", 200, 299, Plus).minus(chr1_100_200_300_400_plus) ===
        Block("chr1", 200, 299, Plus), "1bp gap between blocks")
      assert(Block("chr1", 201, 299, Plus).minus(chr1_100_200_300_400_plus) ===
        Block("chr1", 201, 299, Plus), "1bp gap between blocks")
      assert(Block("chr1", 1801, 2099, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1801, 2099, Plus), "1bp gap between blocks")
      assert(Block("chr1", 1601, 1699, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1601, 1699, Plus), "1bp gap between blocks")
      assert(Block("chr1", 1801, 2099, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1801, 2099, Plus), "1bp gap between blocks")
      assert(Block("chr1", 1600, 1699, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1600, 1699, Plus), "1bp gap between blocks")
      assert(Block("chr1", 1800, 2099, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1800, 2099, Plus), "1bp gap between blocks")
      assert(Block("chr1", 1601, 1700, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1601, 1700, Plus), "1bp gap between blocks")
      // Outside span
      assert(Block("chr1", 1400, 1499, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1400, 1499, Plus), "1bp gap between blocks")
      assert(Block("chr1", 2301, 2400, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 2301, 2400, Plus), "1bp gap between blocks")
      assert(Block("chr1", 1400, 1500, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 1400, 1500, Plus), "1bp gap between blocks")
      assert(Block("chr1", 2300, 2400, Plus).minus(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("chr1", 2300, 2400, Plus), "1bp gap between blocks")
    }
  }
  ...
  def minusBlockSetBlock(): Unit = {
    test("BlockSet minus Block") {
      ...
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.minus(chr1_1000_2000_both) === Empty,
        "Block completely contains block set, sharing two endpoints")
      // Block nested inside block set sharing one endpoint
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.minus(Block("chr1", 1000, 1050, Plus)) === BlockSet(List(
        Block("chr1", 1050, 1100, Plus),
        Block("chr1", 1200, 1300, Plus),
        Block("chr1", 1900, 2000, Plus)
      )),
        "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.minus(Block("chr1", 1050, 1100, Plus)) === BlockSet(List(
        Block("chr1", 1000, 1050, Plus),
        Block("chr1", 1200, 1300, Plus),
        Block("chr1", 1900, 2000, Plus)
      )),
        "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.minus(Block("chr1", 1200, 1250, Plus)) === BlockSet(List(
        Block("chr1", 1000, 1100, Plus),
        Block("chr1", 1250, 1300, Plus),
        Block("chr1", 1900, 2000, Plus)
      )),
        "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.minus(Block("chr1", 1250, 1300, Plus)) === BlockSet(List(
        Block("chr1", 1000, 1100, Plus),
        Block("chr1", 1200, 1250, Plus),
        Block("chr1", 1900, 2000, Plus)
      )),
        "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.minus(Block("chr1", 1900, 1950, Plus)) === BlockSet(List(
        Block("chr1", 1000, 1100, Plus),
        Block("chr1", 1200, 1300, Plus),
        Block("chr1", 1950, 2000, Plus)
      )),
        "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.minus(Block("chr1", 1950, 2000, Plus)) === BlockSet(List(
        Block("chr1", 1000, 1100, Plus),
        Block("chr1", 1200, 1300, Plus),
      ...
      assert(chr1_1900_2100_3000_4000_plus.minus(chr1_1000_2000_both) === BlockSet(List(
        ...
        "Overlapping one block off end")
      assert(chr1_1900_2100_3000_4000_plus.minus(chr1_1500_2500_plus) === Block("chr1", 3000, 4000, Plus),
        "Overlapping one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1400, 1550, Plus)) === BlockSet(List(
        Block("chr1", 1550, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1550, 1650, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1550, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1650, 1750, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1750, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1750, 1850, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1750, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 2000, 2150, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2150, 2300, Plus)
      )), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 2200, 2350, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2200, Plus)
      )), "Overlapping one block off end")
      // Overlapping two blocks off end
      assert(chr1_1700_1800_1900_2100_plus.minus(chr1_1000_2000_both) === Block("chr1", 2000, 2100, Plus),
        "Overlapping two blocks off end")
      assert(chr1_1700_1800_1900_2100_plus.minus(Block("chr1", 1750, 2200, Plus)) === Block("chr1", 1700, 1750, Plus),
        "Overlapping two blocks off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1400, 1750, Plus)) === BlockSet(List(
        Block("chr1", 1750, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Overlapping two blocks off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1550, 1850, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1550, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Overlapping two blocks off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1650, 2200, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 2200, 2300, Plus)
      )), "Overlapping two blocks off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1750, 2400, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1750, Plus)
      )), "Overlapping two blocks off end")
      // Overlapping one block and intron
      assert(chr1_1500_1600_2100_2300_plus.minus(chr1_1000_2000_both) === Block("chr1", 2100, 2300, Plus),
        "Overlapping one block and an intron")
      assert(chr1_1500_1600_2100_2300_plus.minus(chr1_2000_3000_plus) === Block("chr1", 1500, 1600, Plus),
        "Overlapping one block and an intron")
      // Overlapping two blocks and intron
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(chr1_1000_2000_both) === Block("chr1", 2100, 2300, Plus),
        "Overlapping two blocks and an intron")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1650, 2400, Plus)) ===
        Block("chr1", 1500, 1600, Plus), "Overlapping two blocks and an intron")
      // Overlapping three blocks and intron
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus.minus(Block("chr1", 500, 6500, Plus)) ===
        Block("chr1", 7000, 8000, Plus), "Overlapping three blocks and an intron")
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus.minus(Block("chr1", 2500, 8500, Plus)) ===
        Block("chr1", 1000, 2000, Plus), "Overlapping three blocks and an intron")
      // Same span as one block
      assert(chr1_1000_2000_3000_4000_plus.minus(chr1_1000_2000_both) ===
        Block("chr1", 3000, 4000, Plus), "Same span as one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1500, 1600, Plus)) === BlockSet(List(
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Same span as one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1700, 1800, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Same span as one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 2100, 2300, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus)
      )), "Same span as one block")
      // Contains one block and overlaps two adjacent blocks
      ...
      // Contains two blocks and overlaps two adjacent blocks
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus.minus(Block("chr1", 1500, 7500, Plus)) === BlockSet(List(
        Block("chr1", 1000, 1500, Plus),
        Block("chr1", 7500, 8000, Plus)
      )), "Contains two blocks and overlaps two adjacent blocks")
      // Contains one block sharing an endpoint
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1400, 1600, Plus)) === BlockSet(List(
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1500, 1650, Plus)) === BlockSet(List(
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1650, 1800, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1700, 1850, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 2000, 2300, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus)
      )), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 2100, 2400, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus)
      )), "Contains one block sharing an endpoint")
      // Non-overlapping because different spans
      ...
      assert(chr1_100_200_300_400_plus.minus(Block("chr1", 500, 600, Both)) === BlockSet(List(
        Block("chr1", 100, 200, Plus),
        Block("chr1", 300, 400, Plus)
      )), "Non-overlapping because different spans")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1000, 1100, Both)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Non-overlapping because different spans")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 2400, 2500, Both)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Non-overlapping because different spans")
      ...
      // Same span as an intron
      // Two blocks
      assert(chr1_100_200_300_400_plus.minus(Block("chr1", 200, 300, Plus)) === BlockSet(List(
        Block("chr1", 100, 200, Plus),
        Block("chr1", 300, 400, Plus)
      )), "Same span as an intron")
      // Three blocks
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1600, 1700, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Same span as an intron")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1800, 2100, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Same span as an intron")
      // Adjacent to span
      // Two blocks
      assert(chr1_100_200_300_400_plus.minus(Block("chr1", 50, 100, Plus)) === BlockSet(List(
        Block("chr1", 100, 200, Plus),
        Block("chr1", 300, 400, Plus)
      )), "Adjacent to span")
      assert(chr1_100_200_300_400_plus.minus(Block("chr1", 400, 500, Plus)) === BlockSet(List(
        Block("chr1", 100, 200, Plus),
        Block("chr1", 300, 400, Plus)
      )), "Adjacent to span")
      // Three blocks
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1400, 1500, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Same span as an intron")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 2300, 2400, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "Same span as an intron")
      // 1bp gap between blocks
      // In intron
      assert(chr1_100_200_300_400_plus.minus(Block("chr1", 201, 300, Plus)) === BlockSet(List(
        Block("chr1", 100, 200, Plus),
        Block("chr1", 300, 400, Plus)
      )), "1bp gap between blocks")
      assert(chr1_100_200_300_400_plus.minus(Block("chr1", 200, 299, Plus)) === BlockSet(List(
        Block("chr1", 100, 200, Plus),
        Block("chr1", 300, 400, Plus)
      )), "1bp gap between blocks")
      assert(chr1_100_200_300_400_plus.minus(Block("chr1", 201, 299, Plus)) === BlockSet(List(
        Block("chr1", 100, 200, Plus),
        Block("chr1", 300, 400, Plus)
      )), "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1801, 2099, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1601, 1699, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "1bp gap between blocks")
      ...
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1600, 1699, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1800, 2099, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1601, 1700, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "1bp gap between blocks")
      // Outside span
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 1400, 1499, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.minus(Block("chr1", 2301, 2400, Plus)) === BlockSet(List(
        Block("chr1", 1500, 1600, Plus),
        Block("chr1", 1700, 1800, Plus),
        Block("chr1", 2100, 2300, Plus)
      )), "1bp gap between blocks")
  ...
  def minusBlockSetBlockSet(): Unit = {
    test("BlockSet minus BlockSet") {
      ...
      assert(chr1_1000_2000_3000_4000_plus.minus(chr1_500_600_900_1100_both) === BlockSet(List(
        Block("chr1", 1100, 2000, Plus),
        Block("chr1", 3000, 4000, Plus)
      )), "One block overlapping off end of span")
      assert(chr1_1000_2000_3000_4000_plus.minus(chr1_500_600_1000_2000_both) ===
        Block("chr1", 3000, 4000, Plus), "One block overlapping off end of span")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_2500_2600_2800_9000_plus) ===
        Block("chr1", 1000, 2000, Both), "One block overlapping three blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_500_1000_1500_7000_plus) ===
        Block("chr1", 1000, 1500, Both), "One block overlapping three blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_500_4500_7000_8000_plus) ===
        Block("chr1", 5000, 6000, Both), "One block overlapping two blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_3000_6000_7000_8000_plus) ===
        Block("chr1", 1000, 2000, Both), "One block overlapping two blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_1500_2500_3000_4500_5000_6000_plus) ===
        Block("chr1", 1000, 1500, Both), "One block same")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_3500_3600_5500_5600_7500_7600_8500_9500_plus) === BlockSet(List(
        ...
        Block("chr1", 5000, 5500, Both),
        Block("chr1", 5600, 6000, Both),
        Block("chr1", 7000, 7500, Both),
        Block("chr1", 7600, 8000, Both)
      )), "Three blocks nested in three blocks")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_3500_3600_5100_5200_5300_5400_6500_6600_8500_8600_plus) === BlockSet(List(
        ...
        Block("chr1", 3000, 3500, Both),
        Block("chr1", 3600, 4000, Both),
        Block("chr1", 5000, 5100, Both),
        Block("chr1", 5200, 5300, Both),
        Block("chr1", 5400, 6000, Both),
        Block("chr1", 7000, 8000, Both)
      )), "Three blocks nested in two blocks")
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_1500_1600_2500_6500_7500_7600_7700_7800_plus) === BlockSet(List(
        ...
        Block("chr1", 1600, 2000, Both),
        Block("chr1", 7000, 7500, Both),
        Block("chr1", 7600, 7700, Both),
        Block("chr1", 7800, 8000, Both)
      )), "Three blocks nested in two blocks")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_1500_3500_3600_3700_3800_3900_plus) === BlockSet(List(
        ...
        Block("chr1", 3700, 3800, Both),
        Block("chr1", 3900, 4000, Both),
        Block("chr1", 5000, 6000, Both),
        Block("chr1", 7000, 8000, Both)
      )), "Three blocks overlapping two blocks")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_3000_3100_3200_3300_4500_4600_plus) === BlockSet(List(
        Block("chr1", 1000, 2000, Both),
        Block("chr1", 3100, 3200, Both),
        Block("chr1", 3300, 4000, Both),
        Block("chr1", 5000, 6000, Both)
      ...
      assert(chr1_500_600_1500_1600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 500, 600, Plus), "One block nested, others non-overlapping")
      ...
      assert(chr1_500_1000_1500_1600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 500, 1000, Plus), "One block nested, others non-overlapping")
      ...
      assert(chr1_2500_3000_5500_5600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 2500, 3000, Plus), "One block nested, others non-overlapping")
      assert(chr1_4000_4600_5500_5600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 4000, 4600, Plus), "One block nested, others non-overlapping")
      ...
      assert(chr1_500_600_3500_3600_both.minus(chr1_1000_2000_3000_4000_plus) ===
        Block("chr1", 500, 600, Both), "One block nested, others non-overlapping")
      assert(chr1_1100_1200_2500_3000_both.minus(chr1_1000_2000_3000_4000_plus) ===
        Block("chr1", 2500, 3000, Both), "One block nested, others non-overlapping")
      assert(chr1_1100_1200_4000_4600_both.minus(chr1_1000_2000_3000_4000_plus) ===
        Block("chr1", 4000, 4600, Both), "One block nested, others non-overlapping")
      assert(chr1_2000_3000_3500_3600_both.minus(chr1_1000_2000_3000_4000_plus) ===
        Block("chr1", 2000, 3000, Both), "One block nested, others non-overlapping")
      ...
      assert(chr1_500_600_1000_2000_both.minus(chr1_1000_2000_3000_4000_plus) ===
        Block("chr1", 500, 600, Both), "One block overlapping off end of span")
      ...
      assert(chr1_5000_6000_7000_8000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 7000, 8000, Plus), "One block overlapping one block of other")
      ...
      assert(chr1_3500_3600_4500_6000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 4500, 5000, Plus), "One block overlapping one block, another block nested in another block")
      ...
      assert(chr1_1000_3000_3500_3600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 2000, 3000, Plus), "One block overlapping one block, another block nested in another block")
      ...
      assert(chr1_3500_3600_4000_6000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 4000, 5000, Plus), "One block overlapping one block, another block nested in another block")
      ...
      assert(chr1_2500_3500_5500_5600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 2500, 3000, Plus), "One block overlapping two blocks of other")
      ...
      assert(chr1_5000_6000_7000_8000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 7000, 8000, Plus), "One block same")
      ...
      assert(chr1_1500_1600_3500_3600_5500_6500_plus.minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both) ===
        Block("chr1", 6000, 6500, Plus), "Three blocks nested in three blocks")
      ...
      assert(chr1_3500_3600_5500_5600_7500_7600_8500_9500_plus.minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both) ===
        Block("chr1", 8500, 9500, Plus), "Three blocks nested in three blocks")
      ...
      assert(chr1_1100_1200_1300_1400_3500_3600_6000_7000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both) ===
        Block("chr1", 6000, 7000, Plus), "Three blocks nested in two blocks")
      ...
      assert(chr1_3000_3100_3200_3300_4500_4600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 4500, 4600, Plus), "Two blocks nested in one block")
      ...
      assert(chr1_3000_3100_3200_3300_4500_5000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both) ===
        Block("chr1", 4500, 5000, Plus), "Two blocks nested in one block")
