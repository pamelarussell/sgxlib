...
class FeatureCompareSuite extends FunSuite {
  ...
  test("GenericFeature compare to mRNA") {
    ...
    assert(new GenericFeature(chr1_1000_2000_3000_4000_5000_6000_7000_8000_minus, Some("name"))
      .compare(MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_7000_8000_minus, 1999, 7500, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_7000_8000_minus, 1999, 7500, Some("name"), Some("gene"))
    ...
    // Different blocks, different name
    assert(new GenericFeature(chr1_7000_8000_9000_10000_minus, Some("name"))
      .compare(MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_7000_8000_minus, 1999, 7500, Some("xxxx"), Some("gene"))) > 0)
    assert(MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_7000_8000_minus, 1999, 7500, Some("xxxx"), Some("gene"))
      .compare(new GenericFeature(chr1_7000_8000_9000_10000_minus, Some("name"))) < 0)
  }
  ...
  test("Transcript compare to mRNA") {
    // Same blocks, same name, same gene
    assert(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("gene"))
    ...
    assert(new Transcript(chr1_6000_8000_9000_10000_plus, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("gene"))) < 0)
    // Same blocks, different name, same gene
    assert(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("gene"))
    ...
    assert(new Transcript(chr1_7000_8000_9000_10000_plus, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("gene"))) > 0)
    // Different blocks, different name, same gene
    assert(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("xxxx"), Some("gene"))
      .compare(new Transcript(chr1_7000_8000_9000_10000_plus, Some("name"), Some("gene"))) < 0)
    assert(new Transcript(chr1_7000_8000_9000_10000_plus, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("xxxx"), Some("gene"))) > 0)
    // Same blocks, same name, different gene
    assert(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("gene"))
    ...
    assert(new Transcript(chr1_6000_8000_9000_10000_plus, Some("name"), Some("xxxx"))
      .compare(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("gene"))) > 0)
    // Same blocks, different name, different gene
    assert(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("xxxx"))
      .compare(new Transcript(chr1_6000_8000_9000_10000_plus, None, Some("gene"))) < 0)
    assert(new Transcript(chr1_6000_8000_9000_10000_plus, None, Some("gene"))
      .compare(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("xxxx"))) > 0)
    // Different blocks, same name, different gene
    assert(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("xxxx"))
      .compare(new Transcript(chr1_7000_8000_9000_10000_plus, Some("name"), Some("gene"))) < 0)
    assert(new Transcript(chr1_7000_8000_9000_10000_plus, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("name"), Some("xxxx"))) > 0)
    // Different blocks, different name, different gene
    assert(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("xxxx"), Some("xxxx"))
      .compare(new Transcript(chr1_7000_8000_9000_10000_plus, Some("name"), Some("gene"))) < 0)
    assert(new Transcript(chr1_7000_8000_9000_10000_plus, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_6000_8000_9000_10000_plus, 7000, 8000, Some("xxxx"), Some("xxxx"))) > 0)
  }

  test("mRNA compare to mRNA") {
    // Same blocks, same name, same gene, same CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) === 0)
    // Same blocks, different name, same gene, same CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, None, Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) > 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("xxxx"), Some("gene"))) < 0)
    // Different blocks, same name, same gene, same CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, Some("name"), Some("gene"))) > 0)
    // Different blocks, different name, same gene, same CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, Some("xxxx"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, Some("xxxx"), Some("gene"))) > 0)
    // Same blocks, same name, different gene, same CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) > 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), None)) < 0)
    // Same blocks, different name, different gene, same CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("xxxx"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("xxxx"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("xxxx"))) > 0)
    // Different blocks, same name, different gene, same CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, Some("name"), Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, Some("name"), Some("xxxx"))) > 0)
    // Different blocks, different name, different gene, same CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, Some("xxxx"), Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, Some("xxxx"), Some("xxxx"))) > 0)
    // Same blocks, same name, same gene, different CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("name"), Some("gene"))) > 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    // Same blocks, different name, same gene, different CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("xxxx"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("xxxx"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) > 0)
    ...
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("name"), Some("xxxx"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("name"), Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) > 0)
    // Same blocks, different name, different gene, different CDS start, same CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, None, Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("name"), Some("xxxx"))) > 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("name"), Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, None, Some("gene"))) < 0)
    ...
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, None, Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 900, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1100, None, Some("xxxx"))) > 0)
    // Same blocks, same name, same gene, same CDS start, different CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1050, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1050, Some("name"), Some("gene"))) > 0)
    // Same blocks, different name, same gene, same CDS start, different CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1050, None, Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) > 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1050, None, Some("gene"))) < 0)
    // Different blocks, same name, same gene, same CDS start, different CDS end
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1250, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1250, Some("name"), Some("gene"))) > 0)
    // Different blocks, different name, same gene, same CDS start, different CDS end
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1250, Some("xxxx"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1250, Some("xxxx"), Some("gene"))) > 0)
    // Same blocks, same name, different gene, same CDS start, different CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1050, Some("name"), Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) > 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1050, Some("name"), Some("xxxx"))) < 0)
    ...
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1050, Some("name"), Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1050, Some("name"), Some("xxxx"))) > 0)
    // Different blocks, different name, different gene, same CDS start, different CDS end
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1050, Some("xxxx"), Some("xxxx"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1000, 1050, Some("xxxx"), Some("xxxx"))) > 0)
    ...
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1050, 1250, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1050, 1250, Some("name"), Some("gene"))) > 0)
    // Different blocks, different name, same gene, different CDS start, different CDS end
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1050, 1250, None, Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("xxxx"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("xxxx"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1050, 1250, None, Some("gene"))) > 0)
    // Same blocks, same name, different gene, different CDS start, different CDS end
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1020, 1050, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), None)) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), None)
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1020, 1050, Some("name"), Some("gene"))) > 0)
    ...
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1050, 1250, Some("name"), None)
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1050, 1250, Some("name"), None)) > 0)
    // Different blocks, different name, different gene, different CDS start, different CDS end
    assert(MessengerRNA(chr1_900_1100_1200_1300_plus, 1050, 1250, None, None)
      .compare(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))) < 0)
    assert(MessengerRNA(chr1_900_1100_1900_2100_2900_4100_plus, 1000, 1100, Some("name"), Some("gene"))
      .compare(MessengerRNA(chr1_900_1100_1200_1300_plus, 1050, 1250, None, None)) > 0)
  }
