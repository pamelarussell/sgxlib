...
class RegionCompareSuite extends FunSuite {
  ...
  def compareBlockBlockSet(): Unit = {
    test("Block compare BlockSet") {
      ...
      assert(Block("chr1", 1000, 1050, Plus).compare(chr1_1000_1100_1200_1300_1900_2000_plus) < 0,
        "Block nested inside block set sharing one endpoint")
      assert(Block("chr1", 1050, 1100, Plus).compare(chr1_1000_1100_1200_1300_1900_2000_plus) > 0,
        "Block nested inside block set sharing one endpoint")
      assert(Block("chr1", 1200, 1250, Plus).compare(chr1_1000_1100_1200_1300_1900_2000_plus) > 0,
        "Block nested inside block set sharing one endpoint")
      assert(Block("chr1", 1950, 2000, Plus).compare(chr1_1000_1100_1200_1300_1900_2000_plus) > 0,
        "Block nested inside block set sharing one endpoint")
      // Overlapping one block off end
      assert(chr1_1000_2000_both.compare(chr1_1900_2100_3000_4000_plus) < 0,
        "Overlapping one block off end")
      assert(Block("chr1", 1650, 1750, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "Overlapping one block off end")
      ...
      assert(Block("chr1", 500, 6500, Plus).compare(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus) < 0,
      ...
      assert(chr1_1000_2000_both.compare(chr1_1000_2000_3000_4000_plus) < 0,
        "Same span as one block")
      assert(Block("chr1", 1500, 1600, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) < 0,
        "Same span as one block")
      assert(Block("chr1", 1700, 1800, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "Same span as one block")
      assert(Block("chr1", 2100, 2300, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "Same span as one block")
      ...
      assert(Block("chr1", 1500, 7500, Plus).compare(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus) > 0,
        "Contains two blocks and overlaps two adjacent blocks")
      // Contains one block sharing an endpoint
      assert(Block("chr1", 2100, 2400, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "Contains one block sharing an endpoint")
      // Non-overlapping because different spans
      assert(chr1_1000_2000_plus_1.compare(chr1_100_200_300_400_plus) > 0,
        "Non-overlapping because different spans")
      assert(Block("chr1", 500, 600, Both).compare(chr1_100_200_300_400_plus) > 0,
        "Non-overlapping because different spans")
      assert(Block("chr1", 1000, 1100, Both).compare(chr1_1500_1600_1700_1800_2100_2300_plus) < 0,
        "Non-overlapping because different spans")
      assert(Block("chr1", 2400, 2500, Both).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "Non-overlapping because different spans")
      ...
      // Two blocks
      assert(Block("chr1", 200, 300, Plus).compare(chr1_100_200_300_400_plus) > 0,
        "Same span as an intron")
      // Three blocks
      assert(Block("chr1", 1800, 2100, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "Same span as an intron")
      // Adjacent to span
      assert(Block("chr1", 400, 500, Plus).compare(chr1_100_200_300_400_plus) > 0,
        "Adjacent to span")
      // Three blocks
      assert(Block("chr1", 2300, 2400, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "Same span as an intron")
      // 1bp gap between blocks
      // In intron
      assert(Block("chr1", 1600, 1699, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "1bp gap between blocks")
      assert(Block("chr1", 1601, 1700, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "1bp gap between blocks")
      // Outside span
      assert(Block("chr1", 1400, 1499, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) < 0,
        "1bp gap between blocks")
      // Same span different chromosome
      assert(Block("chr2", 1500, 2300, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "Same span different chromosome")
      // Same span different orientation
      assert(Block("chr1", 1500, 2300, Unstranded).compare(chr1_1500_1600_1700_1800_2100_2300_plus) > 0,
        "Same span different chromosome")
      // Same span, same chromosome, same orientation
      assert(Block("chr1", 1500, 2300, Plus).compare(chr1_1500_1600_1700_1800_2100_2300_plus) < 0,
        "Same span different chromosome")
      // Strictly nested both directions
      assert(chr1_1000_2000_both.compare(chr1_900_2100_3000_4000_plus) > 0,
        "One block of block set completely contains the other block")
      ...
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.compare(chr1_1000_2000_both) < 0,
        "Block completely contains block set, sharing two endpoints")
      // Block nested inside block set sharing one endpoint
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.compare(Block("chr1", 1000, 1050, Plus)) > 0,
        "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.compare(Block("chr1", 1050, 1100, Plus)) < 0,
        "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.compare(Block("chr1", 1200, 1250, Plus)) < 0,
        "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.compare(Block("chr1", 1950, 2000, Plus)) < 0,
        "Block nested inside block set sharing one endpoint")
      // Overlapping one block off end
      assert(chr1_1900_2100_3000_4000_plus.compare(chr1_1000_2000_both) > 0,
        "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1650, 1750, Plus)) < 0,
        "Overlapping one block off end")
      // Overlapping two blocks off end
      ...
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(chr1_1000_2000_both) > 0,
        "Overlapping two blocks and an intron")
      // Overlapping three blocks and intron
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus.compare(Block("chr1", 500, 6500, Plus)) > 0,
        "Overlapping three blocks and an intron")
      // Same span as one block
      assert(chr1_1000_2000_3000_4000_plus.compare(chr1_1000_2000_both) > 0,
        "Same span as one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1500, 1600, Plus)) > 0,
        "Same span as one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1700, 1800, Plus)) < 0,
        "Same span as one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 2100, 2300, Plus)) < 0,
        "Same span as one block")
      // Contains one block and overlaps two adjacent blocks
      assert(chr1_900_1100_1500_1600_1900_2100_plus.compare(chr1_1000_2000_both) < 0,
        "Contains one block and overlaps two adjacent blocks")
      // Contains two blocks and overlaps two adjacent blocks
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus.compare(Block("chr1", 1500, 7500, Plus)) < 0,
        "Contains two blocks and overlaps two adjacent blocks")
      // Contains one block sharing an endpoint
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 2100, 2400, Plus)) < 0,
        "Contains one block sharing an endpoint")
      // Non-overlapping because different spans
      assert(chr1_100_200_300_400_plus.compare(chr1_1000_2000_plus_1) < 0,
        "Non-overlapping because different spans")
      assert(chr1_100_200_300_400_plus.compare(Block("chr1", 500, 600, Both)) < 0,
        "Non-overlapping because different spans")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1000, 1100, Both)) > 0,
        "Non-overlapping because different spans")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 2400, 2500, Both)) < 0,
        "Non-overlapping because different spans")
      // Non-overlapping because different orientations
      ...
      // Same span as an intron
      // Two blocks
      assert(chr1_100_200_300_400_plus.compare(Block("chr1", 200, 300, Plus)) < 0,
        "Same span as an intron")
      // Three blocks
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1800, 2100, Plus)) < 0,
        "Same span as an intron")
      // Adjacent to span
      assert(chr1_100_200_300_400_plus.compare(Block("chr1", 400, 500, Plus)) < 0,
        "Adjacent to span")
      // Three blocks
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 2300, 2400, Plus)) < 0,
        "Same span as an intron")
      // 1bp gap between blocks
      // In intron
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1600, 1699, Plus)) < 0,
        "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1601, 1700, Plus)) < 0,
        "1bp gap between blocks")
      // Outside span
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1400, 1499, Plus)) > 0,
        "1bp gap between blocks")
      // Same span different chromosome
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr2", 1500, 2300, Plus)) < 0,
        "Same span different chromosome")
      // Same span different orientation
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1500, 2300, Unstranded)) < 0,
        "Same span different chromosome")
      // Same span, same chromosome, same orientation
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr1", 1500, 2300, Plus)) > 0,
        "Same span different chromosome")
      // Same span, different chromosome, different orientation
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.compare(Block("chr2", 1500, 2300, Both)) < 0,
        "Same span different chromosome different orientation")
    }
  }
