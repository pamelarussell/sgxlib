...
class FeatureMinusSuite extends FunSuite {
  ...
  def minusBlockSetBlockSet(): Unit = {
    test("BlockSet minus BlockSet") {
      ...
      assert(chr1_1000_2000_3000_4000_plus.minus(chr1_500_600_1000_2000_both, "name") ===
        Block("chr1", 3000, 4000, Plus, "name"), "One block overlapping off end of span")
      assert(chr1_1000_2000_3000_4000_plus.minus(chr1_500_600_900_2000_both, "name") ===
        Block("chr1", 3000, 4000, Plus, "name"), "One block overlapping off end of span")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_500_6500_7000_8000_plus, "name") ===
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_500_600_1000_7000_plus, "name") ===
        Empty, "One block overlapping three blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_2500_2600_2800_9000_plus, "name") ===
        Block("chr1", 1000, 2000, Both, "name"), "One block overlapping three blocks of other")
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_2500_8500_9000_10000_plus, "name") ===
        Block("chr1", 1000, 2000, Both, "name"), "One block overlapping three blocks of other")
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_1500_5500_6000_8000_plus, "name") === BlockSet(List(
        Block("chr1", 1000, 1500, Both, ""),
        Block("chr1", 5500, 6000, Both, "")
      ), "name"), "One block overlapping three blocks of other")
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_500_1000_1500_7000_plus, "name") ===
        Block("chr1", 1000, 1500, Both, "name"), "One block overlapping three blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_500_600_2000_9000_plus, "name") ===
        Block("chr1", 1000, 2000, Both, "name"), "One block overlapping three blocks of other")
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_2000_2600_2800_9000_plus, "name") ===
        Block("chr1", 1000, 2000, Both, "name"), "One block overlapping three blocks of other")
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_2000_8500_9000_10000_plus, "name") ===
        Block("chr1", 1000, 2000, Both, "name"), "One block overlapping three blocks of other")
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_500_4500_7000_8000_plus, "name") ===
        Block("chr1", 5000, 6000, Both, "name"), "One block overlapping two blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_3000_6000_7000_8000_plus, "name") ===
        Block("chr1", 1000, 2000, Both, "name"), "One block overlapping two blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_500_5000_7000_8000_plus, "name") ===
        Block("chr1", 5000, 6000, Both, "name"), "One block overlapping two blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_2000_6000_7000_8000_plus, "name") ===
        Block("chr1", 1000, 2000, Both, "name"), "One block overlapping two blocks of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_1500_2500_3000_4500_5000_6000_plus, "name") ===
        Block("chr1", 1000, 1500, Both, "name"), "One block same")
      assert(chr1_1000_2000_3000_4000_5000_6000_both.minus(chr1_1000_2000_3000_4000_5000_6000_plus, "name") ===
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_plus, "name") ===
        Empty, "Self")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both.minus(chr1_1000_2000_2500_6500_7000_8000_plus, "name") === Empty, "Two blocks same")
      ...
      assert(chr1_500_600_1500_1600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 500, 600, Plus, "name"), "One block nested, others non-overlapping")
      ...
      assert(chr1_500_1000_1500_1600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 500, 1000, Plus, "name"), "One block nested, others non-overlapping")
      ...
      assert(chr1_2500_3000_5500_5600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 2500, 3000, Plus, "name"), "One block nested, others non-overlapping")
      assert(chr1_4000_4600_5500_5600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 4000, 4600, Plus, "name"), "One block nested, others non-overlapping")
      ...
      assert(chr1_500_600_3500_3600_both.minus(chr1_1000_2000_3000_4000_plus, "name") ===
        Block("chr1", 500, 600, Both, "name"), "One block nested, others non-overlapping")
      assert(chr1_1100_1200_2500_3000_both.minus(chr1_1000_2000_3000_4000_plus, "name") ===
        Block("chr1", 2500, 3000, Both, "name"), "One block nested, others non-overlapping")
      assert(chr1_1100_1200_4000_4600_both.minus(chr1_1000_2000_3000_4000_plus, "name") ===
        Block("chr1", 4000, 4600, Both, "name"), "One block nested, others non-overlapping")
      assert(chr1_2000_3000_3500_3600_both.minus(chr1_1000_2000_3000_4000_plus, "name") ===
        Block("chr1", 2000, 3000, Both, "name"), "One block nested, others non-overlapping")
      ...
      assert(chr1_500_600_1000_2000_both.minus(chr1_1000_2000_3000_4000_plus, "name") ===
        Block("chr1", 500, 600, Both, "name"), "One block overlapping off end of span")
      ...
      assert(chr1_3000_4000_4500_5500_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 4500, 5000, Plus, "name"), "One block overlapping one block of other")
      ...
      assert(chr1_5000_6000_7000_8000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 7000, 8000, Plus, "name"), "One block overlapping one block of other")
      ...
      assert(chr1_1000_2000_3500_3600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") === Empty,
      ...
      assert(chr1_3500_3600_4500_6000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 4500, 5000, Plus, "name"), "One block overlapping one block, another block nested in another block")
      assert(chr1_500_3000_3500_3600_7000_8000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") === BlockSet(List(
        Block("chr1", 500, 1000, Plus, ""),
        Block("chr1", 2000, 3000, Plus, ""),
        Block("chr1", 7000, 8000, Plus, "")
      ), "name"), "One block overlapping one block, another block nested in another block")
      assert(chr1_1000_3000_3500_3600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 2000, 3000, Plus, "name"), "One block overlapping one block, another block nested in another block")
      ...
      assert(chr1_3500_3600_4000_6000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 4000, 5000, Plus, "name"), "One block overlapping one block, another block nested in another block")
      ...
      assert(chr1_2500_3500_5500_5600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 2500, 3000, Plus, "name"), "One block overlapping two blocks of other")
      ...
      assert(chr1_500_600_1000_2000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 500, 600, Plus, "name"), "One block same")
      assert(chr1_3000_4000_5500_6500_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 6000, 6500, Plus, "name"), "One block same")
      ...
      assert(chr1_5000_6000_7000_8000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 7000, 8000, Plus, "name"), "One block same")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Empty, "Same blocks compatible orientation")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_plus, "name") === Empty, "Self")
      assert(chr1_1500_1600_3500_3600_5500_6500_plus.minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both, "name") ===
        Block("chr1", 6000, 6500, Plus, "name"), "Three blocks nested in three blocks")
      ...
      assert(chr1_3500_3600_5500_5600_7500_7600_8500_9500_plus.minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both, "name") ===
        Block("chr1", 8500, 9500, Plus, "name"), "Three blocks nested in three blocks")
      ...
      assert(chr1_1100_1200_1300_1400_3500_3600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both, "name") === Empty, "Three blocks nested in two blocks")
      ...
      assert(chr1_1100_1200_1300_1400_3500_3600_6000_7000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both, "name") ===
        Block("chr1", 6000, 7000, Plus, "name"), "Three blocks nested in two blocks")
      ...
      assert(chr1_1500_3500_3600_3700_3800_3900_plus.minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both, "name") ===
        Block("chr1", 2000, 3000, Plus, "name"), "Three blocks overlapping two blocks")
      assert(chr1_3500_4500_5000_5100_5900_6000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_7000_8000_both, "name") ===
        Block("chr1", 4000, 4500, Plus, "name"), "Three blocks overlapping two blocks")
      ...
      assert(chr1_3000_3100_3200_3300_4500_4600_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 4500, 4600, Plus, "name"), "Two blocks nested in one block")
      assert(chr1_500_4500_5100_5200_5300_5400_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") === BlockSet(List(
        Block("chr1", 500, 1000, Plus, ""),
        Block("chr1", 2000, 3000, Plus, ""),
        Block("chr1", 4000, 4500, Plus, "")
      ), "name"), "Two blocks nested in one block")
      assert(chr1_3000_3100_3200_3300_4500_5000_plus.minus(chr1_1000_2000_3000_4000_5000_6000_both, "name") ===
        Block("chr1", 4500, 5000, Plus, "name"), "Two blocks nested in one block")
      ...
      assert(chr1_900_1100_1900_2100_2900_6000_plus.minus(chr2_900_1100_1900_2100_2900_6000_plus, "name") === BlockSet(List(
