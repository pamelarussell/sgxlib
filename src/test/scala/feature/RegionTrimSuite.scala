...
class RegionTrimSuite extends FunSuite {
  ...
  test("Block trim") {
    ...
    assert(chr1_1000_2000_minus.trim(500, 1001) === Block("chr1", 1000, 1001, Minus))
    assert(chr1_1000_2000_minus.trim(1000, 1010) === Block("chr1", 1000, 1010, Minus))
    assert(chr1_1000_2000_minus.trim(1100, 1200) === Block("chr1", 1100, 1200, Minus))
    assert(chr1_1000_2000_minus.trim(1900, 1999) === Block("chr1", 1900, 1999, Minus))
    assert(chr1_1000_2000_minus.trim(1900, 2000) === Block("chr1", 1900, 2000, Minus))
    assert(chr1_1000_2000_minus.trim(1900, 2001) === Block("chr1", 1900, 2000, Minus))
    assert(chr1_1000_2000_minus.trim(1999, 2001) === Block("chr1", 1999, 2000, Minus))
  ...
  test("BlockSet trim") {
    ...
    assert(chr1_1900_2100_3000_4000_plus.trim(1000, 2000) === Block("chr1", 1900, 2000, Plus), "Overlapping one block off end")
    assert(chr1_1900_2100_3000_4000_plus.trim(1500, 2500) === Block("chr1", 1900, 2100, Plus), "Overlapping one block")
    ...
    assert(chr1_1500_1600_2100_2300_plus.trim(1000, 2000) === Block("chr1", 1500, 1600, Plus), "Overlapping one block and an intron")
    assert(chr1_1500_1600_2100_2300_plus.trim(2000, 3000) === Block("chr1", 2100, 2300, Plus), "Overlapping one block and an intron")
    ...
    assert(chr1_1000_2000_3000_4000_plus.trim(1000, 2000) === Block("chr1", 1000, 2000, Plus), "Same span as one block")
