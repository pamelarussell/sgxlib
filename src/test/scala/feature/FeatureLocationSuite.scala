...
class FeatureLocationSuite extends FunSuite {
  ...
  test("Get chr, start, end, orientation") {
    ...
    assert(MessengerRNA(chr1_1700_1800_1900_2100_plus, 1750, 1950, Some("name"), Some("gene")).getChr === "chr1")
    ...
    assert(MessengerRNA(chr1_1700_1800_1900_2100_plus, 1750, 1950, Some("name"), Some("gene")).getStart === 1700)
    ...
    assert(MessengerRNA(chr1_1700_1800_1900_2100_plus, 1750, 1950, Some("name"), Some("gene")).getEnd === 2100)
    ...
    assert(MessengerRNA(chr1_1700_1800_1900_2100_plus, 1750, 1950, Some("name"), Some("gene")).getOrientation === Plus)
  }
  ...
  test("Get blocks") {
    ...
    assert(MessengerRNA(chr1_1700_1800_1900_2100_plus, 1750, 1760, Some("name"), Some("gene")).getBlocks === List(
      Block("chr1", 1700, 1800, Plus),
      Block("chr1", 1900, 2100, Plus)
    ))
    ...
    assert(MessengerRNA(chr1_1000_2000_minus, 1000, 2000, Some("name"), Some("gene")).getBlocks === List(Block("chr1", 1000, 2000, Minus)))
  }
