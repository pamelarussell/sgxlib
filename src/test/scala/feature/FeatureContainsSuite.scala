...
class FeatureContainsSuite extends FunSuite {
  ...
  test("BlockSet contains") {
    ...
    assert(chr1_1000_1100_1200_1300_1900_2000_plus.contains(Block("chr1", 1250, 1300, Plus, "block")), "Block nested inside block set sharing one endpoint")
    ...
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 2000, 2150, Plus, "block")), "Overlapping one block off end")
    // Overlapping two blocks off end
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 1550, 1850, Plus, "block")), "Overlapping two blocks off end")
    ...
    assert(!chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus.contains(Block("chr1", 500, 6500, Plus, "block")), "Overlapping three blocks and an intron")
    // Same span as one block
    assert(chr1_1000_2000_3000_4000_plus.contains(chr1_1000_2000_both), "Same span as one block")
    assert(chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 1700, 1800, Plus, "block")), "Same span as one block")
    // Contains one block sharing an endpoint
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 1650, 1800, Plus, "block")), "Contains one block sharing an endpoint")
    ...
    assert(!chr1_100_200_300_400_plus.contains(Block("chr1", 500, 600, Both, "block")), "Non-overlapping because different spans")
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 1000, 1100, Both, "block")), "Non-overlapping because different spans")
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 2400, 2500, Both, "block")), "Non-overlapping because different spans")
    ...
    // Two blocks
    assert(!chr1_100_200_300_400_plus.contains(Block("chr1", 200, 300, Plus, "block")), "Same span as an intron")
    // Three blocks
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 1800, 2100, Plus, "block")), "Same span as an intron")
    // Adjacent to span
    // Two blocks
    assert(!chr1_100_200_300_400_plus.contains(Block("chr1", 400, 500, Plus, "block")), "Adjacent to span")
    // Three blocks
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 1400, 1500, Plus, "block")), "Same span as an intron")
    // 1bp gap between blocks
    // In intron
    assert(!chr1_100_200_300_400_plus.contains(Block("chr1", 201, 299, Plus, "block")), "1bp gap between blocks")
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 1601, 1700, Plus, "block")), "1bp gap between blocks")
    // Outside span
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 1400, 1499, Plus, "block")), "1bp gap between blocks")
    assert(!chr1_1500_1600_1700_1800_2100_2300_plus.contains(Block("chr1", 2300, 2400, Plus, "block")), "1bp gap between blocks")
