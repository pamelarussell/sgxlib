...
class FeatureContainsSuite extends FunSuite {
  ...
  test("Generic feature contains mRNA") {
    assert(new GenericFeature(chr1_1000_2000_3000_4000_5000_6000_plus, None)
      .contains(MessengerRNA(chr1_1000_1100_1200_1300_3200_3300_3400_4000_5500_6000_plus, 1000, 1100, None, None)))
    assert(!new GenericFeature(chr1_1000_2000_3000_4000_5000_6000_plus, None).contains(MessengerRNA(chr1_6000_7000_8000_9000_plus, 6000, 7000, None, None)))
  }
  ...
  test("Transcript contains mRNA") {
    assert(new Transcript(chr1_1000_2000_3000_4000_5000_6000_plus, None, None)
      .contains(MessengerRNA(chr1_1000_1100_1200_1300_3200_3300_3400_4000_5500_6000_plus, 1000, 1100, None, None)))
    assert(!new Transcript(chr1_1000_2000_3000_4000_5000_6000_plus, None, None).contains(MessengerRNA(chr1_6000_7000_8000_9000_plus, 6000, 7000, None, None)))
  }

  test("mRNA contains generic feature") {
    assert(MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_plus, 1000, 2000, None, None)
      .contains(new GenericFeature(chr1_1000_1100_1200_1300_3200_3300_3400_4000_5500_6000_plus, None)))
    assert(!MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_plus, 1000, 2000, None, None).contains(new GenericFeature(chr1_6000_7000_8000_9000_plus, None)))
  }

  test("mRNA contains transcript") {
    assert(MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_plus, 1000, 2000, None, None)
      .contains(new Transcript(chr1_1000_1100_1200_1300_3200_3300_3400_4000_5500_6000_plus, None, None)))
    assert(!MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_plus, 1000, 2000, None, None).contains(new Transcript(chr1_6000_7000_8000_9000_plus, None, None)))
  }
  ...
  test("mRNA contains mRNA") {
    assert(MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_plus, 1000, 2000, None, None)
      .contains(MessengerRNA(chr1_1000_1100_1200_1300_3200_3300_3400_4000_5500_6000_plus, 1000, 1100, None, None)))
    assert(!MessengerRNA(chr1_1000_2000_3000_4000_5000_6000_plus, 1000, 2000, None, None)
      .contains(MessengerRNA(chr1_6000_7000_8000_9000_plus, 6000, 7000, None, None)))
  }
