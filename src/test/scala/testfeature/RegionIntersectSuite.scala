...
class RegionIntersectSuite extends FunSuite {
  ...
  def intersectionBlockBlock(): Unit = {
    test("Block intersection") {
      ...
      assert(chr1_1000_2000_plus_1.intersection(chr1_1000_2000_both) === chr1_1000_2000_plus_1,
        "Intersection of blocks with same span should be the block with consensus orientation")
      // Overlapping
      assert(chr1_1000_2000_both.intersection(chr1_1500_2500_plus) === Block("1", 1500, 2000, Plus),
        "Intersection of overlapping blocks")
      assert(chr1_1500_2500_plus.intersection(chr1_1000_2000_both) === Block("1", 1500, 2000, Plus),
        "Intersection of overlapping blocks")
      // Adjacent
  ...
  def intersectionBlockSetBlock(): Unit = {
    test("BlockSet intersect with Block") {
      ...
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.intersection(Block("1", 1000, 1050, Plus)) ===
        Block("1", 1000, 1050, Plus), "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.intersection(Block("1", 1050, 1100, Plus)) ===
        Block("1", 1050, 1100, Plus), "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.intersection(Block("1", 1200, 1250, Plus)) ===
        Block("1", 1200, 1250, Plus), "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.intersection(Block("1", 1250, 1300, Plus)) ===
        Block("1", 1250, 1300, Plus), "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.intersection(Block("1", 1900, 1950, Plus)) ===
        Block("1", 1900, 1950, Plus), "Block nested inside block set sharing one endpoint")
      assert(chr1_1000_1100_1200_1300_1900_2000_plus.intersection(Block("1", 1950, 2000, Plus)) ===
        Block("1", 1950, 2000, Plus), "Block nested inside block set sharing one endpoint")
      // Overlapping one block off end
      assert(chr1_1900_2100_3000_4000_plus.intersection(chr1_1000_2000_both) === Block("1", 1900, 2000, Plus), "Overlapping one block off end")
      assert(chr1_1900_2100_3000_4000_plus.intersection(chr1_1500_2500_plus) === Block("1", 1900, 2100, Plus), "Overlapping one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1400, 1550, Plus)) ===
        Block("1", 1500, 1550, Plus), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1550, 1650, Plus)) ===
        Block("1", 1550, 1600, Plus), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1650, 1750, Plus)) ===
        Block("1", 1700, 1750, Plus), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1750, 1850, Plus)) ===
        Block("1", 1750, 1800, Plus), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 2000, 2150, Plus)) ===
        Block("1", 2100, 2150, Plus), "Overlapping one block off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 2200, 2350, Plus)) ===
      ...
      assert(chr1_1700_1800_1900_2100_plus.intersection(Block("1", 1750, 2200, Plus)) === BlockSet(List(
        Block("1", 1750, 1800, Plus),
        Block("1", 1900, 2100, Plus)
      )), "Overlapping two blocks off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1400, 1750, Plus)) === BlockSet(List(
        Block("1", 1500, 1600, Plus),
        Block("1", 1700, 1750, Plus)
      )), "Overlapping two blocks off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1550, 1850, Plus)) === BlockSet(List(
        Block("1", 1550, 1600, Plus),
        Block("1", 1700, 1800, Plus)
      )), "Overlapping two blocks off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1650, 2200, Plus)) === BlockSet(List(
        Block("1", 1700, 1800, Plus),
        Block("1", 2100, 2200, Plus)
      )), "Overlapping two blocks off end")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1750, 2400, Plus)) === BlockSet(List(
        Block("1", 1750, 1800, Plus),
        Block("1", 2100, 2300, Plus)
      )), "Overlapping two blocks off end")
      // Overlapping one block and intron
      assert(chr1_1500_1600_2100_2300_plus.intersection(chr1_1000_2000_both) === Block("1", 1500, 1600, Plus), "Overlapping one block and an intron")
      assert(chr1_1500_1600_2100_2300_plus.intersection(chr1_2000_3000_plus) === Block("1", 2100, 2300, Plus), "Overlapping one block and an intron")
      ...
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1650, 2400, Plus)) === BlockSet(List(
        Block("1", 1700, 1800, Plus),
        Block("1", 2100, 2300, Plus)
      )), "Overlapping two blocks and an intron")
      // Overlapping three blocks and intron
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus.intersection(Block("1", 500, 6500, Plus)) === BlockSet(List(
        Block("1", 1000, 2000, Plus),
        Block("1", 3000, 4000, Plus),
        Block("1", 5000, 6000, Plus)
      )), "Overlapping three blocks and an intron")
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus.intersection(Block("1", 2500, 8500, Plus)) === BlockSet(List(
        Block("1", 3000, 4000, Plus),
        Block("1", 5000, 6000, Plus),
        Block("1", 7000, 8000, Plus)
      )), "Overlapping three blocks and an intron")
      // Same span as one block
      assert(chr1_1000_2000_3000_4000_plus.intersection(chr1_1000_2000_both) === Block("1", 1000, 2000, Plus), "Same span as one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1500, 1600, Plus)) ===
        Block("1", 1500, 1600, Plus), "Same span as one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1700, 1800, Plus)) ===
        Block("1", 1700, 1800, Plus), "Same span as one block")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 2100, 2300, Plus)) ===
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus.intersection(Block("1", 1500, 7500, Plus)) === BlockSet(List(
      ...
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1400, 1600, Plus)) ===
        Block("1", 1500, 1600, Plus), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1500, 1650, Plus)) ===
        Block("1", 1500, 1600, Plus), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1650, 1800, Plus)) ===
        Block("1", 1700, 1800, Plus), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1700, 1850, Plus)) ===
        Block("1", 1700, 1800, Plus), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 2000, 2300, Plus)) ===
        Block("1", 2100, 2300, Plus), "Contains one block sharing an endpoint")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 2100, 2400, Plus)) ===
        Block("1", 2100, 2300, Plus), "Contains one block sharing an endpoint")
      ...
      // Two blocks
      assert(chr1_100_200_300_400_plus.intersection(Block("1", 200, 300, Plus)) === Empty, "Same span as an intron")
      // Three blocks
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1600, 1700, Plus)) === Empty, "Same span as an intron")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1800, 2100, Plus)) === Empty, "Same span as an intron")
      // Adjacent to span
      // Two blocks
      assert(chr1_100_200_300_400_plus.intersection(Block("1", 50, 100, Plus)) === Empty, "Adjacent to span")
      assert(chr1_100_200_300_400_plus.intersection(Block("1", 400, 500, Plus)) === Empty, "Adjacent to span")
      // Three blocks
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1400, 1500, Plus)) === Empty, "Same span as an intron")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 2300, 2400, Plus)) === Empty, "Same span as an intron")
      // 1bp gap between blocks
      // In intron
      assert(chr1_100_200_300_400_plus.intersection(Block("1", 201, 300, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_100_200_300_400_plus.intersection(Block("1", 200, 299, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_100_200_300_400_plus.intersection(Block("1", 201, 299, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1801, 2099, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1601, 1699, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1801, 2099, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1600, 1699, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1800, 2099, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1601, 1700, Plus)) === Empty, "1bp gap between blocks")
      // Outside span
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1400, 1499, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 2301, 2400, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 1400, 1500, Plus)) === Empty, "1bp gap between blocks")
      assert(chr1_1500_1600_1700_1800_2100_2300_plus.intersection(Block("1", 2300, 2400, Plus)) === Empty, "1bp gap between blocks")
      ...
      // Block nested inside block set sharing one endpoint
      assert(Block("1", 1000, 1050, Plus).intersection(chr1_1000_1100_1200_1300_1900_2000_plus) ===
        Block("1", 1000, 1050, Plus), "Block nested inside block set sharing one endpoint")
      assert(Block("1", 1050, 1100, Plus).intersection(chr1_1000_1100_1200_1300_1900_2000_plus) ===
        Block("1", 1050, 1100, Plus), "Block nested inside block set sharing one endpoint")
      assert(Block("1", 1200, 1250, Plus).intersection(chr1_1000_1100_1200_1300_1900_2000_plus) ===
        Block("1", 1200, 1250, Plus), "Block nested inside block set sharing one endpoint")
      assert(Block("1", 1250, 1300, Plus).intersection(chr1_1000_1100_1200_1300_1900_2000_plus) ===
        Block("1", 1250, 1300, Plus), "Block nested inside block set sharing one endpoint")
      assert(Block("1", 1900, 1950, Plus).intersection(chr1_1000_1100_1200_1300_1900_2000_plus) ===
        Block("1", 1900, 1950, Plus), "Block nested inside block set sharing one endpoint")
      assert(Block("1", 1950, 2000, Plus).intersection(chr1_1000_1100_1200_1300_1900_2000_plus) ===
        Block("1", 1950, 2000, Plus), "Block nested inside block set sharing one endpoint")
      // Overlapping one block off end
      assert(chr1_1000_2000_both.intersection(chr1_1900_2100_3000_4000_plus) === Block("1", 1900, 2000, Plus), "Overlapping one block off end")
      assert(chr1_1500_2500_plus.intersection(chr1_1900_2100_3000_4000_plus) === Block("1", 1900, 2100, Plus), "Overlapping one block")
      assert(Block("1", 1400, 1550, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1500, 1550, Plus), "Overlapping one block off end")
      assert(Block("1", 1550, 1650, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1550, 1600, Plus), "Overlapping one block off end")
      assert(Block("1", 1650, 1750, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1700, 1750, Plus), "Overlapping one block off end")
      assert(Block("1", 1750, 1850, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1750, 1800, Plus), "Overlapping one block off end")
      assert(Block("1", 2000, 2150, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 2100, 2150, Plus), "Overlapping one block off end")
      assert(Block("1", 2200, 2350, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 2200, 2300, Plus), "Overlapping one block off end")
      // Overlapping two blocks off end
      ...
      assert(Block("1", 1750, 2200, Plus).intersection(chr1_1700_1800_1900_2100_plus) === BlockSet(List(
        Block("1", 1750, 1800, Plus),
        Block("1", 1900, 2100, Plus)
      )), "Overlapping two blocks off end")
      assert(Block("1", 1400, 1750, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("1", 1500, 1600, Plus),
        Block("1", 1700, 1750, Plus)
      )), "Overlapping two blocks off end")
      assert(Block("1", 1550, 1850, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("1", 1550, 1600, Plus),
        Block("1", 1700, 1800, Plus)
      )), "Overlapping two blocks off end")
      assert(Block("1", 1650, 2200, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("1", 1700, 1800, Plus),
        Block("1", 2100, 2200, Plus)
      )), "Overlapping two blocks off end")
      assert(Block("1", 1750, 2400, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("1", 1750, 1800, Plus),
        Block("1", 2100, 2300, Plus)
      )), "Overlapping two blocks off end")
      // Overlapping one block and intron
      assert(chr1_1000_2000_both.intersection(chr1_1500_1600_2100_2300_plus) === Block("1", 1500, 1600, Plus), "Overlapping one block and an intron")
      assert(chr1_2000_3000_plus.intersection(chr1_1500_1600_2100_2300_plus) === Block("1", 2100, 2300, Plus), "Overlapping one block and an intron")
      // Overlapping two blocks and intron
      assert(chr1_1000_2000_both.intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("1", 1500, 1600, Plus),
        Block("1", 1700, 1800, Plus)
      )), "Overlapping two blocks and an intron")
      assert(Block("1", 1650, 2400, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === BlockSet(List(
        Block("1", 1700, 1800, Plus),
        Block("1", 2100, 2300, Plus)
      )), "Overlapping two blocks and an intron")
      // Overlapping three blocks and intron
      assert(Block("1", 500, 6500, Plus).intersection(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus) === BlockSet(List(
        Block("1", 1000, 2000, Plus),
        Block("1", 3000, 4000, Plus),
        Block("1", 5000, 6000, Plus)
      )), "Overlapping three blocks and an intron")
      assert(Block("1", 2500, 8500, Plus).intersection(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus) === BlockSet(List(
        Block("1", 3000, 4000, Plus),
        Block("1", 5000, 6000, Plus),
        Block("1", 7000, 8000, Plus)
      )), "Overlapping three blocks and an intron")
      // Same span as one block
      assert(chr1_1000_2000_both.intersection(chr1_1000_2000_3000_4000_plus) === Block("1", 1000, 2000, Plus), "Same span as one block")
      assert(Block("1", 1500, 1600, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1500, 1600, Plus), "Same span as one block")
      assert(Block("1", 1700, 1800, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1700, 1800, Plus), "Same span as one block")
      assert(Block("1", 2100, 2300, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 2100, 2300, Plus), "Same span as one block")
      // Contains one block and overlaps two adjacent blocks
      ...
      // Contains two blocks and overlaps two adjacent blocks
      assert(Block("1", 1500, 7500, Plus).intersection(chr1_1000_2000_3000_4000_5000_6000_7000_8000_plus) === BlockSet(List(
        Block("1", 1500, 2000, Plus),
        Block("1", 3000, 4000, Plus),
        Block("1", 5000, 6000, Plus),
        Block("1", 7000, 7500, Plus)
      ...
      // Contains one block sharing an endpoint
      assert(Block("1", 1400, 1600, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1500, 1600, Plus), "Contains one block sharing an endpoint")
      assert(Block("1", 1500, 1650, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1500, 1600, Plus), "Contains one block sharing an endpoint")
      assert(Block("1", 1650, 1800, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1700, 1800, Plus), "Contains one block sharing an endpoint")
      assert(Block("1", 1700, 1850, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 1700, 1800, Plus), "Contains one block sharing an endpoint")
      assert(Block("1", 2000, 2300, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 2100, 2300, Plus), "Contains one block sharing an endpoint")
      assert(Block("1", 2100, 2400, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) ===
        Block("1", 2100, 2300, Plus), "Contains one block sharing an endpoint")
      // Non-overlapping because different spans
      ...
      // Same span as an intron
      // Two blocks
      assert(Block("1", 200, 300, Plus).intersection(chr1_100_200_300_400_plus) === Empty, "Same span as an intron")
      // Three blocks
      assert(Block("1", 1600, 1700, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "Same span as an intron")
      assert(Block("1", 1800, 2100, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "Same span as an intron")
      // Adjacent to span
      // Two blocks
      assert(Block("1", 50, 100, Plus).intersection(chr1_100_200_300_400_plus) === Empty, "Adjacent to span")
      assert(Block("1", 400, 500, Plus).intersection(chr1_100_200_300_400_plus) === Empty, "Adjacent to span")
      // Three blocks
      assert(Block("1", 1400, 1500, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "Same span as an intron")
      assert(Block("1", 2300, 2400, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "Same span as an intron")
      // 1bp gap between blocks
      // In intron
      assert(Block("1", 201, 300, Plus).intersection(chr1_100_200_300_400_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 200, 299, Plus).intersection(chr1_100_200_300_400_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 201, 299, Plus).intersection(chr1_100_200_300_400_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 1801, 2099, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 1601, 1699, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 1801, 2099, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 1600, 1699, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 1800, 2099, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 1601, 1700, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
      // Outside span
      assert(Block("1", 1400, 1499, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 2301, 2400, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 1400, 1500, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
      assert(Block("1", 2300, 2400, Plus).intersection(chr1_1500_1600_1700_1800_2100_2300_plus) === Empty, "1bp gap between blocks")
  ...
  def intersectionBlockSetBlockSet(): Unit = {
    test("BlockSet intersection with BlockSet") {
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.intersection(chr1_500_600_1500_1600_plus) ===
        Block("1", 1500, 1600, Plus), "One block nested, others non-overlapping")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.intersection(chr1_500_600_700_800_5500_5600_plus) ===
        Block("1", 5500, 5600, Plus), "One block nested, others non-overlapping")
      ...
      assert(chr1_1000_2000_3000_4000_plus.intersection(chr1_1100_1200_2500_3000_both) ===
        Block("1", 1100, 1200, Plus), "One block nested, others non-overlapping")
      ...
      assert(chr1_1000_2000_3000_4000_plus.intersection(chr1_500_600_1000_2000_both) ===
        Block("1", 1000, 2000, Plus), "One block overlapping off end of span")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.intersection(chr1_1500_2500_4000_5000_plus) ===
        Block("1", 1500, 2000, Plus), "One block overlapping one block of other")
      assert(chr1_1000_2000_3000_4000_5000_6000_both.intersection(chr1_2500_3500_7000_8000_plus) ===
        Block("1", 3000, 3500, Plus), "One block overlapping one block of other")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.intersection(chr1_500_600_1000_2000_plus) ===
        Block("1", 1000, 2000, Plus), "One block same")
      ...
      assert(chr1_1000_2000_3000_4000_5000_6000_both.intersection(chr1_2500_2600_4500_4600_5000_6000_plus) ===
        Block("1", 5000, 6000, Plus), "One block same")
