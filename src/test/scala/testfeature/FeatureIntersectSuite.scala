...
class FeatureIntersectSuite extends FunSuite {
  ...
  test("Generic feature intersect mRNA") {
    assert(new GenericFeature(chr1_1500_1600_1700_1800_2100_2300_plus, Some("name"))
      .intersection(MessengerRNA(Block("chr1", 1550, 1650, Plus), 1550, 1580, Some("name"), Some("gene"))) === Some(new GenericFeature(Block("chr1", 1550, 1600, Plus), None)))
    assert(MessengerRNA(Block("chr1", 1550, 1650, Plus), 1550, 1580, Some("name"), Some("gene"))
      .intersection(new GenericFeature(chr1_1500_1600_1700_1800_2100_2300_plus, Some("name"))) === Some(new GenericFeature(Block("chr1", 1550, 1600, Plus), None)))
    assert(MessengerRNA(chr1_1500_1600_1700_1800_2100_2300_plus, 1500, 1590, Some("name"), Some("gene"))
      .intersection(new GenericFeature(Block("chr1", 2300, 2400, Plus), Some("name"))) === None)
    assert(new GenericFeature(chr1_1500_1600_1700_1800_2100_2300_plus, Some("name"))
      .intersection(MessengerRNA(Block("chr1", 2300, 2400, Plus), 2300, 2399, Some("name"), Some("gene"))) === None)
  }
  ...
  test("mRNA intersect mRNA") {
    assert(MessengerRNA(chr1_1500_1600_1700_1800_2100_2300_plus, 1500, 1599, Some("name"), Some("gene"))
      .intersection(MessengerRNA(Block("chr1", 1550, 1650, Plus), 1550, 1580, Some("name"), Some("gene"))) === Some(new GenericFeature(Block("chr1", 1550, 1600, Plus), None)))
    assert(MessengerRNA(Block("chr1", 1550, 1650, Plus), 1550, 1580, Some("name"), Some("gene"))
      .intersection(MessengerRNA(chr1_1500_1600_1700_1800_2100_2300_plus, 1500, 1599, Some("name"), Some("gene"))) === Some(new GenericFeature(Block("chr1", 1550, 1600, Plus), None)))
    assert(MessengerRNA(chr1_1500_1600_1700_1800_2100_2300_plus, 1500, 1599, Some("name"), Some("gene"))
      .intersection(MessengerRNA(Block("chr1", 2300, 2400, Plus), 2300, 2399, Some("name"), Some("gene"))) === None)
    assert(MessengerRNA(chr1_1500_1600_1700_1800_2100_2300_plus, 1500, 1599, Some("name"), Some("gene"))
      .intersection(MessengerRNA(Block("chr1", 2300, 2400, Plus), 2300, 2399, Some("name"), Some("gene"))) === None)
