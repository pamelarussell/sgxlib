...
class FeatureLocationSuite extends FunSuite {
  ...
  test("Get chr, start, end, orientation") {
    assert(new GenericFeature(chr1_1700_1800_1900_2100_plus, Some("name")).getChr === "1")
    assert(new Transcript(chr1_1700_1800_1900_2100_plus, Some("name"), Some("gene")).getChr === "1")
    assert(MessengerRNA(chr1_1700_1800_1900_2100_plus, 1750, 1780, Some("name"), Some("gene")).getChr === "1")
  ...
  test("Get blocks") {
    ...
    assert(new GenericFeature(chr1_1000_2000_minus, Some("name")).getBlocks === List(Block("1", 1000, 2000, Minus)))
    assert(new Transcript(chr1_1000_2000_minus, Some("name"), Some("gene")).getBlocks === List(Block("1", 1000, 2000, Minus)))
    assert(MessengerRNA(chr1_1000_2000_minus, 1000, 1099, Some("name"), Some("gene")).getBlocks === List(Block("1", 1000, 2000, Minus)))
  }
