...
class SamReaderSuite extends FunSuite {
  ...
  test("Count compatible fragments") {
    intercept[IllegalArgumentException](samReaderUnpaired.countCompatibleFragments(new GenericFeature(Block("20", 37500065, 37500486, Minus), None), Plus))
